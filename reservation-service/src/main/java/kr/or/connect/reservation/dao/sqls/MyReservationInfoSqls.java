...
public class MyReservationInfoSqls {
    ...
    public static final String SELECT_BY_USER_ID =
            "SELECT RI.id, RI.product_id, RI.user_id, RI.general_ticket_count, RI.youth_ticket_count, RI.child_ticket_count, RI.reservation_name, RI.reservation_tel, RI.reservation_email," +
